...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'anon': config('DRF_THROTTLE_ANON', default='5/min'),
        'user': config('DRF_THROTTLE_USER', default='30/min'),
    },
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': datetime.timedelta(
        minutes=config('SIMPLE_JWT_ACCESS_TOKEN_LIFETIME_MINUTES', default=15, cast=int)
    ),
